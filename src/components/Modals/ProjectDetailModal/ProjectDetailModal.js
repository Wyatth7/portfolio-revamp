            ...
            <div className="ProjectDetailModal">
                ...
                <div className="tag-container">
                    ...
                    <div className="tags">
                        { project.tags ?
                            ...
                            <p key={index} className="tag project-text">{tag}</p>
                        )) : null }
                    </div>
                </div>
                <div className="project-link-container">
                    ...
                    <div className="project-links">
                        <ProjectLink icon={faGlobe} text="View Website" link={project.link} />
                        <ProjectLink icon={faGithub} text="View Code" link={project.github} />
                    </div>
                </div>
            </div>
        </Modal>
